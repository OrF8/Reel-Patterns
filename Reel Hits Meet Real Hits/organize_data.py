...
TMDB_PATH: str = os.path.join(DATA_DIR_PATH, "clean_tmdb.csv")
CLEAN_TMDB: pd.DataFrame = pd.read_csv(TMDB_PATH)
BIG_REEL_HITS_PATH: str = os.path.join(DATA_DIR_PATH, "reel_hits_big.csv")
SMALL_REEL_HITS_PATH: str = os.path.join(DATA_DIR_PATH, "reel_hits_small.csv")
REEL_HITS_PATH: str = os.path.join(DATA_DIR_PATH, "reel_hits.csv")
